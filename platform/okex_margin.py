...
from aed_quant.const import OKEX_MARGIN
...
class OKExMarginRestAPI:
    ...
    async def get_margin_account_ids(self):
    ...
    async def get_margin_account_id(self, instrument_id):
    ...
    async def create_order(self, action, instrument_id, price, quantity, order_type=ORDER_TYPE_LIMIT, client_oid=None):
        ...
        if order_type == ORDER_TYPE_LIMIT:
            ...
            if action == ORDER_ACTION_BUY:
                info["notional"] = quantity  # buy vwm
            else:
