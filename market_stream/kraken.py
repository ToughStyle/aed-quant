...
from aed_quant.event import EventTrade, EventOrderbook
from aed_quant.platform.kraken import KrakenRestAPI
...
class KrakenMarket:
    ...
    def __init__(self, **kwargs):
        ...
        self.heartbeat_msg = {}
        self._orderbooks = {}  # orderbook data, e.g. {"symbol": {"bids": {"vwm": quantity, ...}, "asks": {...}, "timestamp": 0}, ... }
